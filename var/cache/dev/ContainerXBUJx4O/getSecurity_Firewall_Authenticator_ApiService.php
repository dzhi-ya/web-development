...
class getSecurity_Firewall_Authenticator_ApiService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Core/Product/Security/ApiKeyAuthenticator.php';
        ...
        $a->addListener('Symfony\\Component\\Security\\Http\\Event\\LoginSuccessEvent', [0 => function () use ($container) {
            return ($container->privates['security.listener.session.api'] ?? $container->load('getSecurity_Listener_Session_ApiService'));
        ...
        return $container->privates['security.firewall.authenticator.api'] = new \Symfony\Component\Security\Http\Firewall\AuthenticatorManagerListener(new \Symfony\Component\Security\Http\Authentication\AuthenticatorManager([0 => ($container->privates['App\\Core\\Product\\Security\\ApiKeyAuthenticator'] ?? ($container->privates['App\\Core\\Product\\Security\\ApiKeyAuthenticator'] = new \App\Core\Product\Security\ApiKeyAuthenticator()))], ($container->services['security.token_storage'] ?? $container->getSecurity_TokenStorageService()), $a, 'api', ($container->privates['monolog.logger.security'] ?? $container->load('getMonolog_Logger_SecurityService')), true, true));
    }
}
