...
class getDoctrineMongodb_Odm_DefaultDocumentManagerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $c->addDriver(new \Doctrine\ODM\MongoDB\Mapping\Driver\AnnotationDriver(($container->privates['annotations.cached_reader'] ?? $container->getAnnotations_CachedReaderService()), [0 => (\dirname(__DIR__, 4).'/src/Core/Product/Document')]), 'App\\Core\\Product\\Document');

        $a->setDocumentNamespaces(['AppCoreUser' => 'App\\Core\\Product\\Document']);
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\MongoDBBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Core\\Product\\Repository\\ProductRepository' => ['privates', 'App\\Core\\Product\\Repository\\ProductRepository', 'getProductRepositoryService', true],
            'App\\Core\\Product\\Repository\\UserRepository' => ['privates', 'App\\Core\\Product\\Repository\\UserRepository', 'getUserRepository2Service', true],
            'App\\Core\\User\\Repository\\ContactRepository' => ['privates', 'App\\Core\\User\\Repository\\ContactRepository', 'getContactRepositoryService', true],
            'App\\Core\\User\\Repository\\UserRepository' => ['privates', 'App\\Core\\User\\Repository\\UserRepository', 'getUserRepositoryService', true],
        ], [
            'App\\Core\\Product\\Repository\\ProductRepository' => '?',
            'App\\Core\\Product\\Repository\\UserRepository' => '?',
            'App\\Core\\User\\Repository\\ContactRepository' => '?',
